...
// 2. Write a function called 'varFuncTwo' that has an parameter called inputTwo and set it to a variable called dataTwo
...
// 1. Write a function called 'stringOne' that creates an empty string called strOne
